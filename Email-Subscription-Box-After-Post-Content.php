...
<style type="text/css">
.fform{
background:url('<?php echo get_bloginfo('url'); ?>/wp-content/plugins/Email%20Subscription%20Box%20After%20Post%20Content/images/bg.png') no-repeat;
height:200px;
width:500px;
}
.btn{
background:url('<?php echo get_bloginfo('url'); ?>/wp-content/plugins/Email%20Subscription%20Box%20After%20Post%20Content/images/subscribe-bt.png') no-repeat;
height:36px;
width:135px;
border:none;
outline:none;
...
.emsb-rss{
float:right;
background:url('<?php echo get_bloginfo('url'); ?>/wp-content/plugins/Email%20Subscription%20Box%20After%20Post%20Content/images/rss.png') no-repeat;
width:89px;
height:92px;
position:relative;
top:66px;
